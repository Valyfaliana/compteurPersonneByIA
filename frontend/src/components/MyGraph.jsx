...
const MyGraph = () => {
    ...
    return (
        <div className="bg-white/9 backdrop-blur-sm w-full md:w-9/12 shadow-xl rounded-xl p-6 mx-auto mt-8">
            ...
            <h2 className="text-2xl font-bold text-white">Statistiques des événements</h2>
            <div>
                <label className="mr-2 font-medium text-white">Échelle de temps :</label>
                <select
            ...
            <ResponsiveContainer width="100%" height={350}>
                ...
                <Tooltip />
                <Legend />
                <Area type="monotone" dataKey="entree" stroke="#2563eb" fillOpacity={1} fill="url(#colorEntree)" name="Entrée" />
                </AreaChart>
            </ResponsiveContainer>
            <div className="mt-6">
                <h3 className="font-semibold text-white mb-2">Confiance moyenne par période</h3>
